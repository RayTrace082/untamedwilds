...
public class HuntPackMobTarget<T extends LivingEntity, target, attacked> extends TargetGoal {
    ...
    public HuntPackMobTarget(ComplexMob creature, Class<T> classTarget, boolean checkSight, int hungerThreshold, boolean onlyNearby, boolean isCannibal, final Predicate<? super T > targetSelector) {
