...
public class PantherBigCat extends AbstractBigCat {
    ...
    public void breed() {
        for (int i = 0; i <= 1 + this.rand.nextInt(2); i++) {
            PantherBigCat child = this.func_241840_a((ServerWorld) this.world, this);
            if (child != null) {
    ...
    public PantherBigCat func_241840_a(ServerWorld serverWorld, AgeableEntity ageable) {
    ...
    protected ResourceLocation getLootTable() {
        return ModLootTables.BIGCAT_LOOT_PANTHER;
    }
