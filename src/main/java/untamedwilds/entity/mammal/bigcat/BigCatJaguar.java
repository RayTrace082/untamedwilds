...
public class BigCatJaguar extends BigCatAbstract {

    private static final ResourceLocation TEXTURE = new ResourceLocation("untamedwilds:textures/entity/big_cat/jaguar.png");
    ...
    public BigCatJaguar(EntityType<? extends BigCatAbstract> type, World worldIn) {
        super(type, worldIn);
        this.ecoLevel = 7;
    }
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, 0, true, true, input -> !(input instanceof BigCatJaguar)));
    ...
    public void breed() {
        for (int i = 0; i <= 1 + this.rand.nextInt(2); i++) {
            BigCatJaguar child = this.createChild(this);
            if (child != null) {
    ...
    public BigCatJaguar createChild(AgeableEntity ageable) {
        BigCatJaguar bear = new BigCatJaguar(ModEntity.JAGUAR, this.world);
