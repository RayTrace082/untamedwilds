...
public class BrownBear extends AbstractBear {
    ...
    //private static final BiomeDictionary.Type[] = BiomeDictionary.Type.CONIFEROUS, BiomeDictionary.Type.MOUNTAIN;
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, 0, true, true, input -> !(input instanceof BrownBear)));
    ...
    public void breed() {
        for (int i = 0; i <= 1 + this.rand.nextInt(1); i++) {
            BrownBear child = this.createChild(this);
    ...
    public BrownBear createChild(AgeableEntity ageable) {
        BrownBear bear = new BrownBear(ModEntity.BROWN_BEAR, this.world);
