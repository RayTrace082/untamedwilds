...
public class ModelBigCat extends AdvancedEntityModel<AbstractBigCat>
{
    ...
    public ModelBigCat() {
        ...
        this.head_jaw.setRotationPoint(0.0F, 2.0F, -4.5F);
        this.head_jaw.addBox(-2.0F, 0.0F, -3.0F, 4, 1, 3, 0.0F);
    ...
    public void setRotationAngles(AbstractBigCat big_cat, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        // Controls the blinking/eye closing, by moving the eyes inside the head
        ...
        flap(tail_4, 0.4f * globalSpeed, 0.2f * globalDegree, true, 1.5F, 0f, ageInTicks / 6, 2);
        ...
        // Sleeping Animation TODO: Give an actual sleeping animation
        if (big_cat.sleepProgress > 0) {
            this.progressPosition(body_main, big_cat.sleepProgress, 0.0F, 18.5F, 1.0F, 40);
            this.progressPosition(leg_left_upper, big_cat.sleepProgress, 2.0F, -2.0F, 6F, 40);
            this.progressPosition(leg_left_paw, big_cat.sleepProgress, 0.0F, 7.8F, 0.0F, 40);
            this.progressPosition(arm_left_paw, big_cat.sleepProgress, 0.0F, 7.8F, 0.0F, 40);
            this.progressPosition(leg_right_upper, big_cat.sleepProgress, -2.0F, -2.0F, 6F, 40);
            this.progressPosition(leg_right_paw, big_cat.sleepProgress, 0.0F, 7.8F, 0.0F, 40);
            this.progressPosition(arm_right_paw, big_cat.sleepProgress, 0.0F, 7.8F, 0.0F, 40);
            this.progressRotation(head_neck, big_cat.sleepProgress, -0.5462880558742251F, 0.0F, 0.0F, 40);
            this.progressRotation(leg_left_upper, big_cat.sleepProgress, -0.27314402793711257F, -0.0F, -0.045553093477052F, 40);
            this.progressRotation(leg_left_lower, big_cat.sleepProgress, -1.2292353921796064F, -0.22759093446006054F, 0.045553093477052F, 40);
            this.progressRotation(leg_left_paw, big_cat.sleepProgress, 1.5481070465189704F, 0.0F, 0.0F, 40);
            this.progressRotation(arm_left_upper, big_cat.sleepProgress, 0.27314402793711207F, -6.200655107570901E-17F, -0.24361070658773F, 40);
            this.progressRotation(arm_left_lower, big_cat.sleepProgress, -1.8668041679331349F, 0.0F, 0.10803588069844901F, 40);
            this.progressRotation(arm_left_paw, big_cat.sleepProgress, 1.593485607070823F, -0.18203784098300857F, 0.0F, 40);
            this.progressRotation(leg_right_upper, big_cat.sleepProgress, -0.27314402793711257F, -0.0F, 0.045553093477052F, 40);
            this.progressRotation(leg_right_lower, big_cat.sleepProgress, -1.2292353921796064F, 0.22759093446006054F, -0.045553093477052F, 40);
            this.progressRotation(leg_right_paw, big_cat.sleepProgress, 1.5481070465189704F, 0.0F, 0.0F, 40);
            this.progressRotation(arm_right_upper, big_cat.sleepProgress, 0.27314402793711207F, 6.200655107570901E-17F, 0.24361070658773F, 40);
            this.progressRotation(arm_right_lower, big_cat.sleepProgress, -1.8668041679331349F, 0.0F, -0.10803588069844901F, 40);
            this.progressRotation(arm_right_paw, big_cat.sleepProgress, 1.593485607070823F, 0.18203784098300857F, 0.0F, 40);
            this.progressRotation(tail_1, big_cat.sleepProgress, -1.0471975511965976F, 0.0F, 0.0F, 40);
            this.progressRotation(tail_2, big_cat.sleepProgress, 0.5918411493512771F, 0.0F, 0.0F, 40);
        }
        ...
        if (big_cat.canMove()) {
            if (big_cat.getSpeed() > 0.1f || big_cat.isAngry() || big_cat.isRunning()) { // Running animation
                ...
                walk(arm_right_upper, 0.5f * globalSpeed, 1f * globalDegree, true, 0F, 0f, limbSwing, limbSwingAmount);
                ...
                walk(arm_left_upper, 0.5f * globalSpeed, 1f * globalDegree, true, 0.6F, 0f, limbSwing, limbSwingAmount);
                ...
                walk(leg_right_upper, 0.5f * globalSpeed, 1f * globalDegree, true, 1.4F, 0f, limbSwing, limbSwingAmount);
                ...
                walk(leg_left_upper, 0.5f * globalSpeed, 1f * globalDegree, true, 2F, 0f, limbSwing, limbSwingAmount);
                ...
                walk(arm_right_paw, 0.5f * globalSpeed, 2f * globalDegree, false, 0.4F, 1.0f, limbSwing, limbSwingAmount);
                bob(arm_left_upper, 0.5F * globalSpeed, 0.8F, false, limbSwing, limbSwingAmount);
                walk(arm_left_upper, 0.5f * globalSpeed, 1f * globalDegree, true, 2.4F, 0f, limbSwing, limbSwingAmount);
                ...
                bob(leg_right_upper, 0.5F * globalSpeed, 0.8F, false, limbSwing, limbSwingAmount);
                walk(leg_right_upper, 0.5f * globalSpeed, 1f * globalDegree, true, 1F, 0f, limbSwing, limbSwingAmount);
                ...
                bob(leg_left_upper, 0.5F * globalSpeed, 0.8F, false, limbSwing, limbSwingAmount);
                walk(leg_left_upper, 0.5f * globalSpeed, 1f * globalDegree, true, 3.4F, 0f, limbSwing, limbSwingAmount);
