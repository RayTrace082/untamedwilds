...
public class ModEntity {
    ...
    public static EntityType<PandaBear> PANDA_BEAR = createEntity(ConfigMobControl.addBear.get(), PandaBear::new,  "bear_panda",  1.3F, 1.3F, 15198183, 1776418, animalType.APEX_PRED, 1);
