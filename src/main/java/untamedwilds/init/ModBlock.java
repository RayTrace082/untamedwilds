...
public class ModBlock {
    ...
    // Fauna
    public static RegistryObject<Block> ANEMONE_ROSE_BULB  = createBlock("anemone_rose_bulb", () -> new AnemoneBlock(Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.RED).hardnessAndResistance(0.1F).sound(SoundType.SLIME)), RenderType.getCutout(), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> ANEMONE_SAND  = createBlock("anemone_sand", () -> new AnemoneBlock(Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.PINK).hardnessAndResistance(0.1F).sound(SoundType.SLIME)), RenderType.getCutout(), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> ANEMONE_SEBAE  = createBlock("anemone_sebae", () -> new AnemoneBlock(Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.WHITE_TERRACOTTA).hardnessAndResistance(0.1F).sound(SoundType.SLIME)), RenderType.getCutout(), ItemGroup.DECORATIONS);

    // Flora - Reeds
    public static RegistryObject<Block> COMMON_REED = createBlock("flora_common_reed", () -> new ReedBlock(Block.Properties.create(Material.PLANTS, MaterialColor.GREEN).hardnessAndResistance(0.1F).sound(SoundType.VINE).doesNotBlockMovement()), RenderType.getCutout(), ItemGroup.DECORATIONS, 100);
    // Flora - Bushes
    public static RegistryObject<Block> BUSH_TEMPERATE = createBlock("flora_bush_temperate", () -> new UndergrowthBlock(Block.Properties.create(Material.PLANTS, MaterialColor.GREEN).hardnessAndResistance(1.0F).sound(SoundType.WET_GRASS).doesNotBlockMovement()), RenderType.getCutout(), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> ELEPHANT_EAR = createBlock("flora_elephant_ear", () -> new UndergrowthBlock(Block.Properties.create(Material.PLANTS, MaterialColor.GREEN).hardnessAndResistance(1.0F).sound(SoundType.WET_GRASS).doesNotBlockMovement(), AbstractBlock.OffsetType.XYZ), RenderType.getCutout(), ItemGroup.DECORATIONS);
    ...
    // Flora - Floating
    public static RegistryObject<Block> WATER_HYACINTH = createItemlessBlock("flora_water_hyacinth", () -> new FloatingPlantBlock(Block.Properties.create(Material.PLANTS, MaterialColor.GREEN).hardnessAndResistance(0.0F).sound(SoundType.PLANT).doesNotBlockMovement()), RenderType.getCutout());
    // Flora - Algae
    public static RegistryObject<Block> AMAZON_SWORD = createBlock("flora_amazon_sword", () -> new AlgaeBlock(Block.Properties.create(Material.PLANTS, MaterialColor.GREEN).hardnessAndResistance(0).sound(SoundType.WET_GRASS).doesNotBlockMovement()), RenderType.getCutout(), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> EELGRASS = createBlock("flora_eelgrass", () -> new AlgaeBlock(Block.Properties.create(Material.PLANTS, MaterialColor.GREEN).hardnessAndResistance(0).sound(SoundType.WET_GRASS).doesNotBlockMovement()), RenderType.getCutout(), ItemGroup.DECORATIONS);
    // Flora - Flowers
    public static RegistryObject<Block> ORCHID_MAGENTA = createBlock("flora_orchid_magenta", () -> new EpyphitePlantBlock(Block.Properties.create(Material.PLANTS, MaterialColor.MAGENTA).hardnessAndResistance(0.0F).sound(SoundType.PLANT)), RenderType.getCutout(), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> ORCHID_PURPLE = createBlock("flora_orchid_purple", () -> new EpyphitePlantBlock(Block.Properties.create(Material.PLANTS, MaterialColor.PURPLE).hardnessAndResistance(0.0F).sound(SoundType.PLANT)), RenderType.getCutout(), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> ORCHID_PINK = createBlock("flora_orchid_pink", () -> new EpyphitePlantBlock(Block.Properties.create(Material.PLANTS, MaterialColor.PINK).hardnessAndResistance(0.0F).sound(SoundType.PLANT)), RenderType.getCutout(), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> ORCHID_RED = createBlock("flora_orchid_red", () -> new EpyphitePlantBlock(Block.Properties.create(Material.PLANTS, MaterialColor.RED).hardnessAndResistance(0.0F).sound(SoundType.PLANT)), RenderType.getCutout(), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> TITAN_ARUM = createItemlessBlock("flora_titan_arum", () -> new TitanArumBlock(Block.Properties.create(Material.PLANTS, MaterialColor.GREEN).hardnessAndResistance(2.0F).sound(SoundType.WET_GRASS).doesNotBlockMovement()), RenderType.getCutout());
    ...
    public static <B extends Block> RegistryObject<Block> createBlock(String name, Supplier<? extends B> supplier, @Nullable RenderType renderType, ItemGroup group) {
        return createBlock(name, supplier, renderType, group, 0);
    }

    public static <B extends Block> RegistryObject<Block> createBlock(String name, Supplier<? extends B> supplier, @Nullable RenderType renderType, ItemGroup group, int burnTime) {
    ...
    public static <B extends Block> RegistryObject<Block> createItemlessBlock(String name, Supplier<? extends B> supplier, @Nullable RenderType renderType) {
        RegistryObject<Block> block = ModBlock.BLOCKS.register(name, supplier);
        if (renderType != null) {
            RENDER_TYPE_DATA.add(new Pair<>(block, renderType));
        }
    ...
    public static void registerRendering() {
        for (Pair<RegistryObject<Block>, RenderType> i : RENDER_TYPE_DATA) {
            RenderTypeLookup.setRenderLayer(i.getFirst().get(), i.getSecond());
        }
    }
}
