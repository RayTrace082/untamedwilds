...
public class ModBlock {
    ...
    public static RegistryObject<Block> CARPET_BIGCAT_JAGUAR  = createBlock("carpet_bigcat_jaguar", () -> new BlockCarpet(Block.Properties.create(Material.CARPET, MaterialColor.GOLD).hardnessAndResistance(0.1F).sound(SoundType.CLOTH)), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> CARPET_BIGCAT_LEOPARD  = createBlock("carpet_bigcat_leopard", () -> new BlockCarpet(Block.Properties.create(Material.CARPET, MaterialColor.GOLD).hardnessAndResistance(0.1F).sound(SoundType.CLOTH)), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> CARPET_BIGCAT_LION  = createBlock("carpet_bigcat_lion", () -> new BlockCarpet(Block.Properties.create(Material.CARPET, MaterialColor.BROWN).hardnessAndResistance(0.1F).sound(SoundType.CLOTH)), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> CARPET_BIGCAT_PANTHER  = createBlock("carpet_bigcat_panther", () -> new BlockCarpet(Block.Properties.create(Material.CARPET, MaterialColor.SNOW).hardnessAndResistance(0.1F).sound(SoundType.CLOTH)), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> CARPET_BIGCAT_PUMA  = createBlock("carpet_bigcat_puma", () -> new BlockCarpet(Block.Properties.create(Material.CARPET, MaterialColor.GRAY).hardnessAndResistance(0.1F).sound(SoundType.CLOTH)), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> CARPET_BIGCAT_SNOW  = createBlock("carpet_bigcat_snow_leopard", () -> new BlockCarpet(Block.Properties.create(Material.CARPET, MaterialColor.BLACK).hardnessAndResistance(0.1F).sound(SoundType.CLOTH)), ItemGroup.DECORATIONS);
    public static RegistryObject<Block> CARPET_BIGCAT_TIGER  = createBlock("carpet_bigcat_tiger", () -> new BlockCarpet(Block.Properties.create(Material.CARPET, MaterialColor.BROWN).hardnessAndResistance(0.1F).sound(SoundType.CLOTH)), ItemGroup.DECORATIONS);
