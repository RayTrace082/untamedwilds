...
public class ConfigFeatureControl {
    ...
    ConfigFeatureControl(final ForgeConfigSpec.Builder builder) {
        ...
        freqWater = builder.comment("Frequency of Freshwater Mobs, 1 in N chunks will generate with Freshwater Mobs (0 to disable)").defineInRange("gencontrol.freqwater", 3, 0, Integer.MAX_VALUE);
