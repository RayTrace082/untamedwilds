...
public class ConfigFeatureControl {
    ...
    ConfigFeatureControl(final ForgeConfigSpec.Builder builder) {
        ...
        freqCritter = builder.comment("Frequency of Critters, 1 in N chunks will generate with Critters (0 to disable)").defineInRange("gencontrol.freqcritter", 2, 0, Integer.MAX_VALUE);
